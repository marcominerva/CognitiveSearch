...
namespace TranslateFunction
{
    ...
    {
        private static readonly string path = "https://api.cognitive.microsofttranslator.com/translate?api-version=3.0";
            ...
            TraceWriter log)
        {
            ...
            toLanguage = "en"; //data?.values?.First?.data?.language?.Value as string;
        ...
        private static async Task<string> TranslateText(string originalText, string toLanguage)
        {
